...
// import { Plus, Phone, MapPin, X, Upload } from "lucide-react";
// import Link from "next/link";
// import { useAddTechnicianMutation } from "@/redux/libraryApi"; // ✅ Import API hook
...
//       workStartTime: formData.workHours.split("-")[0]?.trim() || "09:00",
//       workEndTime: formData.workHours.split("-")[1]?.trim() || "18:00",
//     };
...
//                 onClick={handleSubmit}
//                 disabled={isLoading}
//                 className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2.5 rounded-lg text-sm font-medium hover:from-blue-700 hover:to-purple-800 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
//               >
...
export default function TechniciansPage() {
  ...
  const technicians: Technician[] = data?.meta || [];
        ...
        {technicians.map((tech) => (
          ...
          >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
                        tech.name
                      )}&background=4F46E5&color=fff`; // Blue gradient avatar
                    }}
                  />
                ) : (
                  <img
            ...
            <div className="flex items-center justify-between border-t border-gray-300 pt-4 mb-6">
              <div className="text-center">
                <div className="text-sm text-gray-500">Jobs Today</div>
                <div className="text-md font-bold text-gray-800">0</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-500">Completed</div>
                <div className="text-md font-bold text-green-400">0</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-500">Pending</div>
                <div className="text-md font-bold text-yellow-500">0</div>
              </div>
            </div>
